...
import { submitMovieContribution } from "../_action/submitContribution"
...
export function ContributionForm({ userId, genres, platforms, isPremium }: ContributionFormProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!isPremium) {
            setError("You have not completed your payment yet. Please upgrade to a Premium subscription to contribute movies.")
        ...
        const result = await submitMovieContribution(formData)
        ...
        return (
            <div className="flex flex-col items-center gap-4 py-12 text-center">
                ...
                <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">Your movie has been sent for review.</p>
                </div>
            </div>
        )
    }
            ...
            <div className="grid gap-4 sm:grid-cols-2">
                ...
                <Field label="Director" required>
                    <Input
                        ...
                        placeholder="e.g. Soulstring Studios"
                        required
                    />
                </Field>
            </div>
