...
import { SeriesContributionForm } from "./_components/SeriesContributionForm";

function hasActiveSubscription(source: unknown): boolean {
...
export default async function UserSeriesContributionsPage() {
    ...
    return (
        <UserPageShell
            activePath="/user/series-contributions"
