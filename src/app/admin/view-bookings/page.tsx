            ...
            <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[220px_minmax(0,1fr)]">
                <aside className="border-r border-slate-200 bg-slate-50 lg:sticky lg:top-0 lg:h-screen">
                    ...
                    <nav className="space-y-1 px-2 pb-6">
                        {sideNavItems.map((item) => {
                            ...
                            const isActive = item.href === "/admin/view-bookings";
                ...
                <div className="min-w-0">
                    <header className="flex h-14 items-center justify-between border-b border-slate-200 bg-slate-50 px-4 sm:px-6">
                        <div>
                            <p className="text-sm font-semibold text-slate-800">View Bookings</p>
                    ...
                    <main className="p-4 sm:p-6">
                        <div className="mx-auto max-w-6xl space-y-4">
                            <header className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                                <p className="text-sm text-slate-500">Admin / View Bookings</p>
                                <h1 className="mt-1 text-3xl font-semibold tracking-tight text-slate-900">View Bookings</h1>
                                <p className="mt-2 text-sm text-slate-600">Use this page to list and moderate booking entries.</p>
                            </header>

                            <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                                <h2 className="text-lg font-semibold text-slate-900">Starter Content Area</h2>
                                <p className="mt-2 text-sm text-slate-600">
                                    Add bookings table, filters, status badges, and detail drawer here.
                                </p>
