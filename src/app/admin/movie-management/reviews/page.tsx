...
function normalizeReviews(raw: unknown): ReviewRow[] {
...
async function approveReviewAction(formData: FormData) {
    ...
    revalidatePath("/admin/movie-management/reviews");
}
    ...
    return (
        <div className="min-h-screen bg-slate-100 text-slate-900">
            <div className="grid min-h-screen grid-cols-1 lg:grid-cols-[260px_minmax(0,1fr)]">
                <AdminSidebar activePath="/admin/movie-management/reviews" />
                ...
                <div className="min-w-0">
                    <header className="flex h-14 items-center justify-between border-b border-slate-200 bg-slate-50 px-4 sm:px-6">
                        <div>
                            ...
                            <p className="text-xs text-slate-500">Review moderation</p>
                        </div>
                    ...
                    <main className="p-4 sm:p-6">
                        <div className="mx-auto max-w-7xl space-y-5">
                            <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                                <p className="text-sm text-slate-500">Admin / Movie Management / Reviews</p>
