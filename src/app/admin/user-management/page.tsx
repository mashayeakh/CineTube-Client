                ...
                <aside className="border-r border-slate-200 bg-slate-50 lg:sticky lg:top-0 lg:h-screen">
                    ...
                    <nav className="space-y-1 px-2 pb-6">
                        {sideNavItems.map((item) => {
                            ...
                            const isActive = item.href === "/admin/user-management";
                    ...
                    <main className="p-4 sm:p-6">
                        <div className="mx-auto max-w-6xl space-y-4">
                            <header className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                                ...
                                <h1 className="mt-1 text-3xl font-semibold tracking-tight text-slate-900">User Management</h1>
                                <p className="mt-2 text-sm text-slate-600">Use this page to manage roles, status, and account actions.</p>
                            </header>

                            <section className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                                <h2 className="text-lg font-semibold text-slate-900">Starter Content Area</h2>
                                <p className="mt-2 text-sm text-slate-600">
                                    Add user list, role update actions, block/unblock flows, and profile preview here.
                                </p>
